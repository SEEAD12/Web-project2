<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $get   = "select * from users where email='".$_POST['email']."' and password='".$_POST['password']."'";
    ...
    <div class='mt-5 xs row'>
        ...
        '>
            ...
            <form action="index.php?page=login" method="post">
                ...
                <button class='btn bg-blue w-100'>تسجيل الدخول</button>
                <a href="index.php?page=create_account" class='d-block text-center'>لا يوجد لديك حساب , إنشاء حساب ؟</a>
            </form>
        </div>
