...
$get = 'select * from interactive_stories where id="'.$_GET['id'].'"';
...
<div class="container" style='direction:rtl'>
    <h3 class='mt-5'><?php echo $row['title']?></h3>
...
<hr>
    ...
    <?php if(isset($_SESSION['email'])){?>
        <form method='POST' action='index.php?page=interactive_stories&id=<?php echo $_GET['id']?>'>
